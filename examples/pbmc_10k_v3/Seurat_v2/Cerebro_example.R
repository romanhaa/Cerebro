...
monocle_all_cells <- setOrderingFilter(monocle_all_cells, seurat@var.features)
...
monocle_subset_of_cells <- setOrderingFilter(monocle_subset_of_cells, seurat@var.features)
